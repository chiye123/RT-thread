...
#if defined(BSP_USING_SOFTWARE_CRC16)
    if (ctx->crc_cfg.width == 16 && ctx->crc_cfg.poly == 0x8005)
    {
        result =  (rt_uint32_t)calc_crc16((uint8_t *)in, length);
    }
    else
#endif /* define(BSP_USING_SOFTWARE_CRC16) */
    {
